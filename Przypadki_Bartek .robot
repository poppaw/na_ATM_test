...
Wypłata gotówki opcja 1
    ...
    [Documentation]     Po spełnieniu wymagań z test casów nr 1 i 2 , 
...                     ekran wyświetla opcje "sprawdź stan konta" oraz "wypłata gotówki".
...                     Klikam opcję wypłata gotówki. Ekran wyświetla opcje (50, 100, 200, 300, 400, 500, 750, 1000) 
...
Wypłata karta bez debetu, kasa a koncie = True kasa w bankomacie = True
    [Setup]         przy wystarczających zasobach na koncie, wystarczających zasobach w bankomacie, karta inna niż debetowa

[Documentation]     Po spełnieniu wymagań z test casów nr 1 i2 ,
...                 ekran wyświetla opcje "sprawdź stan konta" oraz "wypłata gotówki".
...
...                 Bankomat drukuje potwierdzenie
...                 Odbieram kartę
[Teardown]      Wróc do ustawień początkowych z testcase 1 i 2
...
...                     Bankomat  pokazuję informację o maksymalnej wartości wypłaconej gotówki 9900zł PASS
